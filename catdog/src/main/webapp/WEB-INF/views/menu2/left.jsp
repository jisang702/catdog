...
<div class="list-group">
       ...
       <a href="${pageContext.request.contextPath}/guest/guest" class="list-group-item">방명록</a>
       <a href="${pageContext.request.contextPath}/bbs/list" class="list-group-item">게시판</a>
