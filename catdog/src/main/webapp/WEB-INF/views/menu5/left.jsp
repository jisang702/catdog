...
<div class="list-group">
       ...
       <a href="${pageContext.request.contextPath}/mypage/info" class="list-group-item">정보확인</a>
       ...
       <a href="${pageContext.request.contextPath}/member/pwd" class="list-group-item">정보수정</a>
