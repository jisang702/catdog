	...
	<table style=" margin: 30px; border-spacing: 0px;">
		<c:forEach var="dto" items="${list}" varStatus="status">
		    ...
		    <tr height='35' style='background: #eeeeee;'>
		    	<th width='200px' style='padding:5px 5px; border:1px solid #cccccc; border-right:none;'>
		    		<span>작성자</span>
		    	</th>
		    	
		    	<th width='300px' style='padding:5px 5px; border:1px solid #cccccc;' align='center'>
		    		<span>카테고리</span>
		    	</th>
		    	
		    	
		    	<th width='300px' style='padding:5px 5px; border:1px solid #cccccc; border-left:none;' align='right'>
		    		<span>작성일</span>
		    	</th>
		    </tr>
		    ...
		    <tr>
		       ...
		       <td width='300px' style='padding:5px 5px; border:1px solid #cccccc;' align='center'>
		           <span>
		              ${dto.qnaCategory==1?"상품문의" : (dto.qnaCategory==2?"배송문의":"교환/환불")}
		           </span>
		        </td>
		        
		       <td width='300px' style='padding:5px 5px; border:1px solid #cccccc; border-left:none;' align='right'>
		          <span>${dto.qnaCreated}</span>
		        </td>
		    </tr>

		    <tr>
		        <td width='100%' colspan='3' align="left" valign='top' style='padding:5px 5px; border:1px solid #cccccc;'>
		    ...
		    <c:choose>
		    	<c:when test="${not empty dto.qnaansContent}">
				    <tr>
				        <td colspan='3' valign='top' style='padding:5px 5px 5px 15px; border:1px solid #cccccc; border-top:none;'>
