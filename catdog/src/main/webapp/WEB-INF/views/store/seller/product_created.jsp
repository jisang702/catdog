			      ...
			      <c:if test="${mode!='update'}">
				      <td style="padding-left:10px;">
				            <select name="prdCategoryNum" class="selectField">
				                ...
				                <option value="3" ${dto.prdCategoryNum==6 ? "selected='selected'" : ""}>케어</option>
				                <option value="4" ${dto.prdCategoryNum==7 ? "selected='selected'" : ""}>리빙</option>
				                <option value="5" ${dto.prdCategoryNum==8 ? "selected='selected'" : ""}>외출</option>
				                <option value="6" ${dto.prdCategoryNum==9 ? "selected='selected'" : ""}>장난감</option>
				                <option value="7" ${dto.prdCategoryNum==10 ? "selected='selected'" : ""}>패션</option>
				                <option value="8" ${dto.prdCategoryNum==11 ? "selected='selected'" : ""}>기타</option>
				            </select>
				      </td>
			      </c:if>
			  </tr>
