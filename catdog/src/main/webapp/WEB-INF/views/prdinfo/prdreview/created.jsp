...
<form name="boardForm" method="post" enctype="multipart/form-data">
  ...
  <tr align="left" height="40" style="border-bottom: 1px solid #cccccc;">
      ...
      <td style="padding-left:10px;"> 
        <input type="text" name="subject" maxlength="100" class="boxTF" style="width: 95%;" value="${dto.qnaSubject}"
  ...
  <tr align="left" height="40" style="border-bottom: 1px solid #cccccc;">
      ...
      <td style="padding-left:10px;">
        <input type="radio" name="questionPrivate" value="1" ${empty dto || dto.qnaSecret==1?"checked='checked'":"" }> 공개
        <input type="radio" name="questionPrivate" value="2" ${dto.qnaSecret==2?"checked='checked'":"" }> 비공개
      </td>
  </tr>
