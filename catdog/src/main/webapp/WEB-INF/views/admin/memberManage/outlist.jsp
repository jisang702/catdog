...
$(function(){
	...
	$("ul.tabs li").click(function(){
		...
		var url="${pageContext.request.contextPath}/admin/memberManage/outlist?group="+tab;
		location.href=url;
	});
});
...
function searchList(){
	...
	f.action="${pageContext.request.contextPath}/admin/memberManage/outlist";
	f.submit();
}
			...
			<table style="width: 100%; margin: 10px auto; border-spacing: 0px;">
			   <tr height="40">
			      <td align="left" width="100">
			          <button type="button" class="btn" onclick="javascript:location.href='${pageContext.request.contextPath}/admin/memberManage/outlist';">새로고침</button>
			      </td>
			      <td align="center">
			          <form name="searchForm" action="${pageContext.request.contextPath}/admin/memberManage/outlist" method="post">
