...
<table style='width: 100%; margin: 10px auto 30px; border-spacing: 0px;'>
	...
	<c:forEach var="vo" items="${listReply}">
	    <tr height='35' style='background: #E6F8E0;'>
	    ...
	    <tr>
	        ...
	        <td style='padding:7px 5px;' align='right'>
                <button type='button' class='btn btnSendReplyLike' data-vidReplyNum='${vo.vidReplyNum}' data-vidReplyLike='1' title="좋아요"><i class="far fa-thumbs-up"></i> <span>${vo.likeCount}</span></button>	        
	        </td>
	    </tr>
	        ...
	        <td colspan='2'>
	            ...
	            <div style='clear: both; padding: 10px 10px;'>
	             ...
	             <div style='padding: 0px 13px 10px 10px; text-align: right;'>
	                <button type='button' class='btn btnSendReplyAnswer' style="background-color: #71DA65; color: #FFF; border:2px soild #FFF;" data-vidReplyNum='${vo.vidReplyNum}'>답글 등록</button>
	            </div>
