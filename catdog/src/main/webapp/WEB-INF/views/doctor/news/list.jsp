...
<div class="alert-info">
	<i class="fas fa-info-circle"></i> 중요한 일정 및 알림, 이벤트 등은 공지사항 통해 고객님께 알려드립니다.
</div>
		...
		<tr align="center" bgcolor="#ffffff" height="35"
			...
			<td>
				<c:if test="${dto.fileCount > 0}">
					<a href="${pageContext.request.contextPath}/doctor/news/zipdownload?newsNum=${dto.newsNum}"><i class="fas fa-file-archive"></i></a>
				</c:if>
			</td>
